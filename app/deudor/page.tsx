...
export default async function DeudorDashboard() {
    ...
    return (
      <div className="max-w-lg mx-auto mt-16 text-center">
        <div className="bg-white rounded-xl border border-gray-200 p-8">
          ...
          <h2 className="text-lg font-semibold text-gray-900">Sin deuda asignada</h2>
          <p className="text-gray-500 mt-2 text-sm">
            Tu cuenta está creada pero aún no tienes una deuda asignada.
            Contacta a quien te debe cobrar para que complete el proceso.
          </p>
        </div>
      </div>
    )
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 mt-1">Estado de tu deuda y pagos</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card title="Monto">
          <div className="space-y-4">
            <div>
              <p className="text-4xl font-bold text-blue-700">{formatCLP(monto)}</p>
              <p className="text-sm text-gray-500 mt-1">Monto acordado</p>
            </div>
          </div>
        </Card>
      </div>
      ...
      {/* Payment history */}
      <Card title="Historial de pagos" subtitle="Últimos 24 períodos">
                  ...
                  return (
                    <tr key={pago.id} className="border-b border-gray-50 hover:bg-gray-50">
                      ...
                      <td className="py-2.5 text-right font-medium">
                        {pago.valor_clp ? formatCLP(pago.valor_clp) : formatCLP(Math.round(Number(pago.valor_uf)))}
                      </td>
